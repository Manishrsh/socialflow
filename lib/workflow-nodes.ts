...
export const NODE_TYPES = {
  ...
  ACTION_SEND_WHATSAPP_FLOW: 'actionSendWhatsAppFlow',
...
export const ACTION_NODES = [
  ...
  {
    type: NODE_TYPES.ACTION_SEND_WHATSAPP_FLOW,
    label: 'Send WhatsApp Flow',
    description: 'Send a Meta WhatsApp Flow for appointments or other form journeys',
    category: 'Actions',
    icon: '🗓️',
    ...
    config: [
      ...
      },
      {
        ...
        label: 'Message',
        type: 'textarea',
        placeholder: 'We can help you book your appointment. Tap below to continue.',
        required: true,
      },
      {
        key: 'header',
      ...
      {
        key: 'flowToken',
        label: 'Flow Token (Optional)',
        type: 'text',
        placeholder: 'booking_{{phone}}',
        required: false,
      },
      {
        key: 'flowAction',
      ...
      },
      {
        ...
        type: 'textarea',
        placeholder: '{"service":"consultation","branch":"main"}',
        required: false,
      },
      {
        key: 'bookAsAppointment',
        label: 'Save As Appointment',
        type: 'select',
        options: ['yes', 'no'],
        required: false,
      },
